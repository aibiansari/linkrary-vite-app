    ...
    <AnimatePresence>
      {buttonState && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          onClick={handleClose}
          className="dark:bg-black/50 bg-black/20 fixed font-Raleway inset-0 z-50 grid place-items-center"
        >
          <motion.div
                  ...
                  {filteredCards.map((card, index) => (
                    <div key={index} className="relative group">
                      <motion.a
                        ...
                        className="bg-stone-100 dark:bg-element rounded-lg shadow-md p-4 flex items-center space-x-4 hover:bg-white dark:hover:bg-body hover:shadow-none hover:ring-1 ring-stone-300 dark:ring-element shadow-black/10 dark:shadow-black/40 transition-all duration-300 group"
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <h3 className="text-xl text-hover dark:text-white font-semibold">
                            {card.title}
                          </h3>
