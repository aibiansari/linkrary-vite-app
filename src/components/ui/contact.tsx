      ...
      >
        <div className="relative w-full max-w-4xl px-8">
          ...
          <textarea
            ...
            rows={12}
            required
            className="w-full p-3 text-neutral-800 dark:text-neutral-400 placeholder:dark:text-neutral-600 bg-transparent border border-neutral-600 dark:border-slate-200 rounded-md shadow-lg shadow-black/35 transition-colors duration-500"
          ></textarea>
        </div>
