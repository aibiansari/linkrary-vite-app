...
const Section: React.FC<SectionProps> = ({ title, children }) => (
  <section className="mx-8 mb-10">
    <h1 className="text-black font-semibold text-2xl md:text-3xl dark:text-gray-200">
      {title}
    </h1>
    {children}
  </section>
...
const SocialIcon: React.FC<SocialIconProps> = ({ href, viewBox, path }) => (
  <a href={href} target="_blank" rel="noopener noreferrer">
    <svg
      fill="currentColor"
      className="w-6 h-6 text-neutral-950 dark:text-gray-300 hover:text-neutral-800 dark:hover:text-gray-400 transition-all duration-300"
      viewBox={viewBox}
    >
      <path d={path} />
    </svg>
    ...
    >
      ...
      <div className="max-w-4xl mt-24 w-full">
        ...
        <Section title="Your Thoughts Matter to Me">
          <p className="text-neutral-950 dark:text-gray-300 mt-4">
            I'm always looking for ways to improve Linkrary and make it more
            useful for you. Whether you have a suggestion for a new feature, a
            tool that I could add to the cards, or feedback about the site, I
        ...
        <section className="flex w-full text-black dark:text-white justify-center">
